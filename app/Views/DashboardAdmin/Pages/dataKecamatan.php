                    ...
                    <div class="modal-body">
                      <form action="<?= base_url('admin/kecamatan/' . $row["KODE_POS"] . '/edit') ?>" method="post">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="kecamatan" id="formControlname" placeholder="Nama Wisata" value="<?= $row["KECAMATAN"] ?>">
                        </div>
      ...
      DeleteItem.addEventListener("click", (e) => {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            window.location.href = `https://geolocationwisata.com/Dashboard/tabelwisata/${getID}/${publicIdImg}/${publicIdVid}/delete`;
          }
        })
      })
    }
