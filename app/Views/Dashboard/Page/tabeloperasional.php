                        ...
                        <div class="modal-body">
                          <form action="<?= base_url('/Dashboard/harioperasi/'.$row["ID_OPERASIONAL"].'/edit')?>" method="post" >
                            ...
                            <div class="mb-3">
                              ...
                              <select class="form-select" name="kode_pos" aria-label="Default select example" id="formControlId_Wisata">
                            ...
                            <div class="mb-3">
                              ...
                              <select class="form-select" name="kode_pos" aria-label="Default select example" id="formControlKode_jam">
